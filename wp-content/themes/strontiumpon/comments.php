...
<div class="post-box post-box-replies post-box-comments">
	<div class="title">
		...
		<p><?php _e('Tell us what you think.'); ?></p>
	</div>
	...
	<?php else : ?>
		<p class="no-comments"><?php ('There are no comments on this entry.'); ?></p>
	<?php endif; ?>
	</div>
</div>
	...
	<div class="interior post-box-reply-interior">
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="comment-form">
			...
			<p class="input input-small input-name">
				<label for="comment-author"><?php _e('Name:'); ?> <small><?php if ($req)  _e('(Required)'); ?></small></label>
			...
			<p class="input input-small input-email">
				<label for="comment-email"><?php _e('E-mail:'); ?><small><?php if ($req) _e('(Required)'); else _e('(Optional)'); ?></small></label>
			...
			<p class="input input-website">
				<label for="comment-url"><?php _e('QQ:'); ?> <small>(Optional)</small></label>
			...
			<?php endif; ?>
			<p class="inpit">
				<label for="comment-comment"><?php _e('Comments:'); ?> </label>
