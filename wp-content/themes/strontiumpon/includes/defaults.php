...
if (!$installed) {
	...
	update_option(PADD_NAME_SPACE . '_featured_slide_wait','5');
	update_option(PADD_NAME_SPACE . '_featured_slide_speed','1000');
	...
	update_option(PADD_NAME_SPACE . '_ads_468015_1','<a href="http://www.paddsolutions.com">Padd Solutions</a>');
	...
	update_option(PADD_NAME_SPACE . '_ads_space_1','
		<img alt="Advertisement" style="float:left" src="' . get_template_directory_uri() . '/images/advertisement-300x250.jpg" />
		<img alt="Advertisement" style="float:right" src="' . get_template_directory_uri() . '/images/advertisement-300x250.jpg" />
